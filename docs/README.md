...
| R6-I-P6 programmed input runtime wiring | `docs/operations/r6-i-p6-programmed-input-runtime-wiring.md` | dry-run / WebSocket publisher wiring for programmed target input source, including `--preset sweep_x` smoke notes |
| R6-I completion audit | `docs/operations/r6-i-completion-audit.md` | R6-I completion audit and parent #133 close readiness |
| WebSocket publisher runner | `docs/operations/websocket-publisher-runner.md` | local/dev WebSocket delivery for payload v0 and short manual viewer smoke commands |
...
| Backend / viewer startup guide | `docs/operations/backend-viewer-startup.md` | README handoff for backend / dry-run / HTTP-served viewer / browser connection startup |
