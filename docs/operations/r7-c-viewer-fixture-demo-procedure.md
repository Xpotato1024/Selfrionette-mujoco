...
- `assets/mujoco/fast_arm/fixtures/fast_arm_sweep_x_qpos.json` は fast_arm Robot Plugin resourceが所有する canonical debug fixture である。生成は `uv run python scripts/export_wasm_qpos_fixture.py --preset sweep_x --steps 30` を使う
