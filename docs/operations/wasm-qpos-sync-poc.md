...
>
> 2026-07-15 update: the first post-retirement fixture regeneration was rejected
> as invalid because stale MuJoCo velocity state caused BADQACC and simulation
> time rollback. Issue #392 repaired the native generation path; the executable
> PoC remains retired and the product-owned fixture is generated by the current
