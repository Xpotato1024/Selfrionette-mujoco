"""Canonical mapped runtime pipeline and retained public compatibility object."""
...
class RuntimePipeline:
    """Public interpreter-based compatibility object retained until C4."""

    config: RuntimeConfig
    input_source: InputSource
    input_interpreter: Any
