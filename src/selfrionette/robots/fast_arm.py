"""Single declarative source for the fast_arm robot profile."""

from __future__ import annotations

from pathlib import Path

from selfrionette.robot_profile import CoordinateUnitContract, EndpointReference, RobotProfile
...
FAST_ARM_ROBOT_PROFILE = RobotProfile(
    ...
    backend_kind="mujoco",
    mujoco_model_asset=_REPOSITORY_ROOT / "assets" / "mujoco" / "fast_arm" / "scene.xml",
    canonical_joint_names=FAST_ARM_JOINT_NAMES,
    qpos_dimension=4,
    qvel_dimension=4,
    initial_keyframe_name="home",
    endpoint=EndpointReference(site_name="tip", body_name="fore_arm_link"),
    joint_limit_config_asset=_REPOSITORY_ROOT / "configs" / "fast_arm" / "joint_limits.toml",
