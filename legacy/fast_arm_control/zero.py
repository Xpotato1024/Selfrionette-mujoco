...
def arm_update():
    ...
    while(not end_flag):
        arm_update.cnt = arm_update.cnt + 0.001
        tip_pos[0] = 0.02 * math.sin(arm_update.cnt)
        tip_pos[2] = -0.6 + 0.02 * math.sin(arm_update.cnt)
        tip_pos[3] = math.pi / 60.0 * math.sin(arm_update.cnt)
        print(tip_pos)
